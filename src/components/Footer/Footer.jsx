...
import './Footer.css'
import olx_app_img from '../../../src/images/phone-app.png';
import appstore_img from '../../../src/images/appstore_2x.png';
import playstore_img from '../../../src/images/playstore_2x.png'
    ...
    render() {
        return (
            <div className="container-fluid">
                <div className="row">
                    <div className="container-fluid try_olx_app">
                        <div className="row">
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-4">
                                        <div>
                                            <img src={olx_app_img} alt="OLX APP SNAPSHOT" width='100%'/>
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className='try_olx_app_text'>
                                            <div className='oa_1stText'>
                                                <span >TRY THE OLX APP</span>
                                            </div>
                                            <div className='oa_2ndText'>
                                        ...
                                        <div className="">
                                            ...
                                            <div className='app_images'>
                                                <div style={{ flex: 1, marginRight: 5 }}>
                                                    <img src={appstore_img} alt="Apple Store" width='100%'/>
                                                </div>
                                                <div style={{ flex: 1 }}>
                                                    <img src={playstore_img} alt="Play Store" width='100%'/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="container-fluid _2nd_footer">
                        <div className="row">
                            <div className="container">
                                <div className="row">
                                    <div className='footer_links'>
                                        ...
                                        <div className='footer_links_flex'>
                                            ...
                                            <div>
                                                ...
                                                <div className='small_app_icons'>
                                                    <div className='small_app_images'>
                                                        <img src={appstore_img} alt="Apple Store" width='100%' height='100%' />
                                                    </div>
                                                    <div className='small_app_images'>
                                                        <img src={playstore_img} alt="Play Store" width='100%' height='100%' />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="container-fluid last_footer">
                        <div className="container">
                            <div className="row">
                                <div className='olx_country'>
                                    <div className='other_countries'>
                                        <span>Other Countries</span>
                                        <a href="https://www.olx.in/" >India</a>
                                        -
                                        <a href="https://www.olx.co.za/" >South Africa</a>
                                        -
                                        <a href="https://www.olx.co.id/">Indonesia</a>
                                    </div>
